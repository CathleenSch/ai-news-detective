...
def calculate_burstiness_parameter(texts, vectors):
    print('Calculating Burstiness Parameter')
...
def calculate_simpsons_index(texts, vectors):
    print('Calculating Simpson\'s Index')
...
def add_scores_to_embeddings(scores, embeddings):
    embeddings = [list(embedding) for embedding in embeddings]
    
    for i in range(len(embeddings)):
        embeddings[i].append(scores[i])
